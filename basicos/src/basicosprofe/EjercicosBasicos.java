 ...
 **/
	...
	public static void calculoImc() {
	   ...
	   float squared_heigth = height*height;
	   
	   imc = weight/squared_heigth;
		
		if (imc<16) System.out.println("Su imc es DESNUTRIDO");
		
		else if(imc>=16 && imc<18) {
			System.out.println("su imc es DELGADO");
		}
		
		else if(imc>=18 && imc<25) {
			System.out.println("su imc es IDEAL");
		}
			...
			System.out.println("su imc es OBESO");
		}
